...
!function() {
    var s, i, c, a, o = {
        ...
        x: 0,
        y: 0
    }, f = !1, m = document.documentElement, l = [], w = /^Mac/.test(navigator.platform), h = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    function y() {
        if (!f && document.body) {
            ...
            p.fixedBackground || d || (e.style.backgroundAttachment = "scroll",
    ...
    function x(u, f, m) {
        ...
        if (b.push({
            ...
            null == u.$scrollBehavior && function(e) {
                ...
                return T[t]
            }(u) && (u.$scrollBehavior = u.style.scrollBehavior,
            ...
            var h = function(e) {
                ...
                w ? window.scrollBy(o, r) : (o && (u.scrollLeft += o),
                r && (u.scrollTop += r)),
                f || m || (b = []),
                    b.length ? j(h, u, 1e3 / p.frameRate + 1) : (g = !1,
                    null != u.$scrollBehavior && (u.style.scrollBehavior = u.$scrollBehavior,
                        u.$scrollBehavior = null))
            };
            j(h, u, 0),
                g = !0
        }
    ...
    function e(e) {
        ...
        e.wheelDeltaY && K(e.wheelDeltaY, 120) && (r = e.wheelDeltaY / Math.abs(e.wheelDeltaY) * -120)),
        ...
        return n ? !!function(e) {
            ...
            var t = 120 < e && P(e)
                , o = !P(120) && !P(100) && !t;
            return e < 50 || o
        }(r) || (1.2 < Math.abs(o) && (o *= p.stepSize / 120),
        1.2 < Math.abs(r) && (r *= p.stepSize / 120),
            x(n, o, r),
            e.preventDefault(),
            void O()) : !u || !_ || (Object.defineProperty(e, "target", {
    ...
    function S(e) {
        ...
        if (e.defaultPrevented || /^(textarea|select|embed|object)$/i.test(t.nodeName) || N(t, "input") && !r.test(t.type) || N(s, "video") || function(e) {
            ...
            return !0;
        if ((N(t, "button") || N(t, "input") && r.test(t.type)) && e.keyCode === h.spacebar)
            return !0;
    ...
    function I(e) {
        return 1 <= e ? 1 : e <= 0 ? 0 : (1 == p.pulseNormalize && (p.pulseNormalize /= F(1)),
            F(e))
    }
    var V = window.navigator.userAgent
        ...
        , ee = function() {
        if (J)
            return ~allowedBrowsers.indexOf("Mobile");
